...
import Staff_PieComp from "./Staff_PieComp";
import Staff_Graph from "./Staff_Graph";
  ...
  return (
    <div className="pt-[25px] px-[25px] bg-[#090909] overflow-hidden pb-10">
      ...
      <div className="flex mt-[22px] w-full gap-[30px] ">
        ...
        <div className="basis-[30%] border bg-gray-800 shadow-md cursor-pointer rounded-[20px]">
