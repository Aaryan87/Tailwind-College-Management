...
function FileUpload() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-800 bg-file-upload bg-cover bg-center">
      <div className="p-4 flex flex-col justify-center items-center backdrop-blur-md">
        <div {...getRootProps()} className="flex justify-center items-center w-full h-52 px-4 transition bg-gray-800 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:border-gray-400 focus:outline-none">
          <input {...getInputProps()} />
